...
- Choose the search space carefully; it's often the hardest part
- Small inputs don't guarantee fast algorithms—analyze operations
- Binary Search (`bisect`) is much faster than Linear Search on sorted data
- Modules organize code; don't execute logic on import
